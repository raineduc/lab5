...
public class SaveCommand implements Command {
  ...
  private MnemonicDefinition definition;
  private static String info = "сохранить коллекцию в файл";

  public SaveCommand(Console console, FlatStorage storage, MnemonicDefinition definition) {
  ...
  public void execute() {
    ...
    console.executeCommand(new SimpleEntry<>(definition, getAllCommand));
  }
